...
public class LikeServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int oldLikeCount = likeDAO.countLikesByPost(userId);
        likeDAO.toggleLike(userId, postId);
        boolean isLiked = likeDAO.isLikedByUser(userId, postId);
        int likeCount = likeDAO.countLikesByPost(postId);

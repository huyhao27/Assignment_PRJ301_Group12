                ...
                <div class="order-header">
                    ...
                    <div class="order-actions">
                        <form action="greeting" method="post">
                            ...
                            <input type="submit" class="btn btn-outline" value="Liên hệ người mua"/>
                        </form>
                        <%if(order.getStatus().equals("Pending")||order.getStatus().equals("Processing")){%>
                        <form action="shipping" method="post" onsubmit="return confirm('Bạn có chắc chắn muốn gửi đơn hàng này?');">
                            <input type="hidden" name="orderId" value="<%= orderId %>"/>
                            <input type="submit" class="btn btn-primary" value="Gửi hàng"/>
                        </form>
                        <%}%>
                    </div>
                </div>
